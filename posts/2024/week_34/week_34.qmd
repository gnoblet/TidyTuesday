  ...
  gg$annotate(
    ...
    label = sgr$str_wrap(
      paste0(
        ...
        " was ",
        abs(max_diff),
        " years older than consort ",
        max_case$consort_name,
        ". "
      ),
      35
    ),
  ...
  gg$annotate(
    ...
    label = sgr$str_wrap(
      paste0(
        ...
        " was ",
        abs(min_diff),
        " years younger than consort ",
        min_case$consort_name
      ),
      30
    ),
    color = "#3d5941",
  ...
  gg$labs(
    ...
    subtitle = sgr$str_wrap(
      paste0(
        ...
        max_year,
        ", Consorts were ",
        "<b><span style='color:#3d5941'>older</span></b>",
        " than Monarchs for ",
        "<b><span style='color:#3d5941'>",
        older_consorts,
        " marriages</span></b> only."
      ),
      75
    ),
