...
This week's TidyTuesday focused on EuroLeague Basketball, the premier men’s club basketball competition in Europe.. I explored [KEY_INSIGHTS] using r to [VISUALIZATION_APPROACH].
...
# titles
title <- "Bigger mean winner? Geographic overview of EuroLeague Basketball teams"
subtitle <- branding(
  github = "gnoblet",
  bluesky = "gnoblet",
